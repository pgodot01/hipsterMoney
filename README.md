...
To optimize the realestate application for production, run:
...
[Doing API-First development]: https://www.jhipster.tech/documentation-archive/v5.0.0/doing-api-first-development/
